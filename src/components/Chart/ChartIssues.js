        ...
        <>
            ...
            <View>
                ...
                <View style={{ flexDirection: 'column', paddingHorizontal: 10 }}>
                    {data.map((item) => (
                    <View key={item.id} style={{ flexDirection: 'row', alignItems: 'center', marginTop: 15, marginBottom: 4, borderBottomColor: 'black', borderBottomWidth: 0.5 }}>
                        <View style={{ width: 15, height: 15, backgroundColor: item.color, marginRight: 8 }} />
                        <Text>{item.number_issues} {item.name}</Text>
                    </View>
                    ))}
                </View>
